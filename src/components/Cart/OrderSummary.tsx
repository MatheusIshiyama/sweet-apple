...
export function OrderSummary(props: OrderSummaryProps) {
  ...
  const { subtotal, total, onCheckout, onDiscount, children, isLoading } = props;
  ...
  return (
    <Stack spacing="8" borderWidth="1px" borderColor={useColorModeValue('gray.400', 'gray.700')} rounded="lg" padding="8" width="full">
      ...
      <Stack spacing="6">
        ...
        <OrderSummaryItem label="Coupon Code">
          {coupon ? (
            <HStack spacing={4}>
              <Tag size="md" borderRadius="full" variant="solid" bg="red" color="white">
                <TagLabel>SweetApple10</TagLabel>
      ...
      <Button isLoading={isLoading} variant="primaryButton" size="lg" fontSize="md" rightIcon={<FaArrowRight />} onClick={onCheckout}>
        Place Order
      </Button>
    </Stack>
  );
